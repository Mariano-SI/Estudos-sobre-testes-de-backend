...
describe('Testes da classe Carrinho', () => {
  ...
  it('Tentar finalizar uma compra sem item, exceção deve ser lançada', () => {
    const carrinho = new Carrinho();
  ...
  it('Deve finalizar compras com sucesso', () => {
    const item = new Item('Banana', 2, 5);
    ...
    expect(carrinho.finalizaCompra()).toStrictEqual({ subtotal: 15, frete: 10, total: 25 });
  });
});
